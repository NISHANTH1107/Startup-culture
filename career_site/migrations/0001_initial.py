...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('assessment', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='result', serialize=False, to='career_site.assessment')),
                ...
                ('banner_color', models.CharField(default='#D4AF37', max_length=7)),
                ('ei_score', models.IntegerField(blank=True, null=True)),
                ('sn_score', models.IntegerField(blank=True, null=True)),
                ('tf_score', models.IntegerField(blank=True, null=True)),
                ('jp_score', models.IntegerField(blank=True, null=True)),
